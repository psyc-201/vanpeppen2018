...
**Clarify key analysis of interest here** The key analysis of interest is seeing the interaction between self-explanations and learning outcomes as well as transfer performance. It will be calculated through a 2 X 2 mixed ANOVA. 
...
Mixed ANOVAs analyses were heavily conducted to test the performance gains on MC-answers. Though the original study employed a 3x2 design, I will analyze the data through a mixed ANOVA 2x2 design. Specifically, I will analyze self-explanation effectiveness and timing (which would compare pretest and immediate posttest). I will be calculating the p-value, effect size (through Cohen's d), and 95% confidence intervals. (add more detail)
