...
## Introduction
I am interested in replicating Van Peppen and colleagues' (2018) study, where they examine how generating explanations for oneself (i.e. self explanations) fosters critical thinking. Understanding the relationship between self-explanation and critical thinking skills directly relates to my first year project, as I am interested in understanding how different explanation strategies (such as AI-generated vs self-explanations) shapes the way learners’ retain and critically think about science. Not only does this study relate to my research interests, but it also provides enough challenge to code and familiarize myself with R. Overall, the ultimate goal is to have this replication project further inform the considerations and study design of my first year project. 
...
One challenge is the original study was conducted in a classroom setting. Though classroom studies reflect genuine learning environments, it is difficult to replicate them due to varying, external factors. Additionally, there is limited funding nor prior notice to implement the intervention in a classroom. To attempt replicating this study, participants will be recruited through UCSD’s sona-system to take the study in-person. Not only will this ensure participants are more engaged and are not using outside sources, but it will also address the second challenge: replicating the participant demographic. In the original study, participants were first-year students enrolled in the Safety and Security Management program offered at Dutch University of Applied Sciences. Recruiting individuals with varying levels of prior knowledge can impact the results. Therefore, restricting the participants to first-year students in introductory-level psychology courses can mitigate substantial differences from the original study.
